...
//        stop();
    ...
    public void start() {
        ...
        if (isInPlaybackState() && mTargetState != STATE_PAUSED) {
    ...
    public void resume() {
        ...
        if ((isInPlaybackState() && mTargetState != STATE_PAUSED && mTargetState != STATE_PLAYING) || mTargetState == STATE_PLAYBACK_COMPLETED) {
            mVideoHandler.obtainMessage(MSG_STOP).sendToTarget();
        }
    ...
    public void resetMediaPlayer() {
        mVideoHandler.obtainMessage(MSG_RELEASE).sendToTarget();
